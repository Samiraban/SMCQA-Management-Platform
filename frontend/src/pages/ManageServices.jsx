...
const ICONS = ["Building2", "BriefcaseBusiness", "UserRound", "Users", "ShieldCheck", "Globe2", "Handshake", "Briefcase"];
  ...
  return (
    <ResourceManager
      ...
      fields={[
        ...
        { key: "image", label: "Photo (image URL or keyword)", required: false },
      ]}
