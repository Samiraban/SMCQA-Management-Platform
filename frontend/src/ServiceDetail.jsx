...
/* =========================================================
   SERVICE DETAIL
   Generic detail page used for every service except
   Hospitality (which has its own department-based layout).

   Props:
   - title      : service title, e.g. "Construction"
   - tagline    : short line under the heading
   - description: main description (from backend, if present)
   - paragraphs : extra "about" paragraphs (from static data)
   - images     : array of { url, fallback } from getGallery()
